    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                max_length=11,
                validators=[
                    django.core.validators.RegexValidator("^09[0|1|2|9][0-9]{8}$")
                ],
        ...
        migrations.AlterField(
            ...
            field=models.ImageField(
                upload_to=accounts.uitils.get_file_path, verbose_name="تصویر شناسنامه"
            ),
        ),
        migrations.AlterField(
            model_name="userdocument",
            name="national_card",
            field=models.ImageField(
                upload_to=accounts.uitils.get_file_path, verbose_name="تصویر کد ملی"
            ),
        ),
        migrations.AlterField(
            model_name="userdocument",
