...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    phone_number = models.CharField(
        max_length=11,
        validators=[RegexValidator(r"^09[0|1|2|9][0-9]{8}$")], verbose_name='شماره تلفن'
    )
...
class UserDocument(TimeStampedModel):
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name="document", verbose_name='کاربر')
    national_card = models.ImageField(upload_to=get_file_path, verbose_name='تصویر کد ملی')
    identity_card = models.ImageField(upload_to=get_file_path, verbose_name='تصویر شناسنامه')
    passport = models.ImageField(upload_to=get_file_path, blank=True, verbose_name='تصویر پاسپورت')
    other = models.ImageField(upload_to=get_file_path, blank=True, verbose_name='سایر مدارک')
